...
function Undrafted(props) {
  ...
  players = players.sort((a, b) => {
    ...
    //return  a.tier - b.tier ||  b.touches - a.touches || b.floor_per_week - a.floor_per_week
    return a.tier - b.tier || b.value - a.value || b.touches - a.touches || b.floor_per_week - a.floor_per_week
  });
